...
class Users(db.Model):
    ...
    # create a string representation
    def __repr__(self):
    	#return f"<Task id={self.title%r}, slug={self.slug%r}>"
    	return '<Title %r>' % self.title, '<Slug %r>' % self.slug


# create a UserForm
# 1) create a form class -- we need a secret key in app.config
# 2) create a web page - xxx.html -- define hidden field
